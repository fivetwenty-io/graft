...
jobs:
  generate:
    ...
    steps:
      ...
      - name: Install Graft
        run: |
          curl -sSL https://github.com/fivetwenty/graft/releases/latest/download/graft-linux-amd64 -o graft
          chmod +x graft
...
variables:
  GRAFT_VERSION: "latest"

.install_graft: &install_graft
  before_script:
    - curl -sSL https://github.com/fivetwenty/graft/releases/${GRAFT_VERSION}/download/graft-linux-amd64 -o /usr/local/bin/graft
...
deploy:production:
  ...
  before_script:
    ...
    - curl -sSL https://github.com/fivetwenty/graft/releases/latest/download/graft-linux-amd64 -o /usr/local/bin/graft
    - chmod +x /usr/local/bin/graft
