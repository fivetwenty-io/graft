...
| [Operator inventory](operators.md) | The full operator set: which of spruce's 25 operators and graft's 44 registered operator names line up, which exist only in graft, and which exist only in spruce. |
